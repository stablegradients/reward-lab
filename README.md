...
This fork trims the visualizer to a comparison of **RLOO, GRPO, TailRL, MaxRL and PKPO** on four starting shapes (bell, uniform, long right tail, binary 1% success) with the Adam optimizer. `core.js` still implements and tests all ten methods; the sound, speed, shape-editor and video-export features of the original are removed.
